...
\begin{itemize}
  ...
  \item Analysis: \texttt{pconv\_efficiency.py}, \texttt{analyze\_extra.py}, \texttt{make\_rich\_figures.py}.
  \item Drivers: \texttt{run\_all.py}, \texttt{run\_upgrade\_15.py}, \texttt{run\_upgrade\_gelu\_eq\_svhn.py}.
  \item Report/demo: \texttt{report.tex}, \texttt{app\_gradio.py}, \texttt{process\_log.md}.
\end{itemize}
